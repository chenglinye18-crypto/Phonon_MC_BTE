...
STEP_END=40000
L_M=2.8e-7
SUMMARY_DIR="output/y280nm_300_373_gradient_summary"
...
CASES=(
  "300|2.5|T300K_pm2p5K|input_y280nm_10nm_Eeff5e-19_T300K_pm2p5K|y280nm_300K_pm2p5K_rerun|output/run_y280nm_300K_pm2p5K_rerun"
...
summary_dir = root / "output" / "y280nm_300_373_gradient_summary"
per_case_dir = summary_dir / "per_case"
step_start = 32000
step_end = 40000
L_m = 2.8e-7
cases = [
    (300.0, 2.5, "T300K_pm2p5K", root / "output" / "run_y280nm_300K_pm2p5K_rerun"),
